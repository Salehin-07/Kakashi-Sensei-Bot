    ...
    <nav class="relative z-10 p-6">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6">
                ...
                <a href="//s" class="text-white hover:text-anime-orange transition-colors">Terms</a>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="glass-effect rounded-xl p-6 hover-lift">
                    <div class="flex items-center mb-4">
                        <span class="text-2xl mr-3">📍</span>
                        <code class="text-anime-orange text-lg font-mono">?setchanel</code>
                    </div>
    ...
    <footer class="relative z-10 px-6 py-12 border-t border-gray-800">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
                <p>&copy; 2025 Kakashi Sensei Bot. All rights reserved. Made with ❤️ for anime fans.</p>
            </div>
        </div>
    </footer>
...
<body class="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 min-h-screen">
    ...
    <footer class="px-6 py-8 border-t border-gray-800 mt-12">
        <div class="max-w-4xl mx-auto text-center text-gray-400">
            <p>&copy; 2025 Kakashi Sensei Bot. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
